...
# Train a dummy model (replace this with actual model training)
model = LogisticRegression()
pickle.dump(model, open('models/crime_model.pkl', 'wb'))
...
def loaded_model(model):
    ...
    json_file = open(model + "_structure.json", 'r')  # Relative path
